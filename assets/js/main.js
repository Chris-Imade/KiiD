document.addEventListener("DOMContentLoaded", (event) => {
  ...
  document.getElementById("footer-copyright-year").textContent =
    new Date().getFullYear();

  // donation page tabs
  const tabButtons = document.querySelectorAll(".ul-tab-nav-pill");
  const tabContents = document.querySelectorAll(".ul-tab-content");
